...
bool DescriptorSet::createDescriptorSets(const std::map<uint32_t, vk::DescriptorBufferInfo>& bufferInfos, const std::map<uint32_t, vk::DescriptorImageInfo>& imageInfos)
{
...
const vk::DescriptorSet& DescriptorSet::handle() const
{
    return m_descriptorSets;
}

const vk::DescriptorSetLayout& DescriptorSet::layout() const
{
